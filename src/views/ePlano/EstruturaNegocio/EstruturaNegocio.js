...
import './EstruturaNegocio.scss'; // Importe ou crie este arquivo para estilizar a página
import EstruturaFisicaModal from './EstruturaNegocioModal'; // Importe o modal de Estrutura Física
import EquipeModal from './EquipeModal'; // Importe o modal de Equipe
...
const EstruturaNegocio = () => {
  ...
  const initialTableData = [
    ...
    ['Equipe de Trabalho','R$ 8.500,00', 'R$ 100,00', 'R$ 200,00', 'R$ 300,00', 'R$ 400,00', 'R$ 500,00', 'R$ 600,00', 'R$ 700,00', 'R$ 800,00', 'R$ 900,00', 'R$ 1.000,00'],
    ['Insumos de Produção e Vendas','R$ 8.500,00', 'R$ 100,00', 'R$ 200,00', 'R$ 300,00', 'R$ 400,00', 'R$ 500,00', 'R$ 600,00', 'R$ 700,00', 'R$ 800,00', 'R$ 900,00', 'R$ 1.000,00'],
  ];
                  ...
                  {equipeData.map((membro) => (
                    <tr key={membro.id}>
                      ...
                      <td>
                        ...
                        <button><Link to={`/excluir-membro/${membro.id}`}><FaTrashAlt /></Link></button>
                      </td>
                    </tr>
                  ))}
                  <tr>
